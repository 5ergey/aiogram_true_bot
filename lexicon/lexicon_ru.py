...
LEXICON_RU: dict[str, str] = {
    ...
    '/translate': 'name, \nВыбери язык, на который хочешь перевести текст'
}
...
LANGUAGES = ["Английский", "Испанский", "Французский", "Итальянский", "Немецкий", "Китайский"]

TRANSLATE: dict[str, str] = {
    'system': 'Ты - переводчик с русского языка на language.'
              'Ты должен переводить на любой известный тебе язык'
